...
using Owin;
using ContosoWeb.Areas.Admin;
using Contoso.Models;
using ContosoWeb.Security;
...
namespace ContosoWeb
{
    public partial class Startup
    {
        ...
        //
        private static readonly string clientId = ConfigurationHelpers.GetString("ida:ClientId");
        private static readonly string aadInstance = ConfigurationHelpers.GetString("ida:AADInstance");
        private static readonly string tenant = ConfigurationHelpers.GetString("ida:Tenant");
        private static readonly string postLogoutRedirectUri = ConfigurationHelpers.GetString("ida:PostLogoutRedirectUri");
        ...
        public static void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(() => Global.UnityContainer.Resolve<IContosoWebContext>());
            ...
            var userManager = CreateUserManager(null, (ContosoWebContext)Global.UnityContainer.Resolve<IContosoWebContext>());
