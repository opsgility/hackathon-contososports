...
{
    public class ContosoWebContext : IdentityDbContext<ApplicationUser>, IContosoWebContext
    {
        public ContosoWebContext(string connectionStringName)
        ...
        public IDbSet<GameStat> GameStats { get; set; }
        ...
        {
            builder.Entity<Player>().HasKey(a => a.PlayerId);
            builder.Entity<Team>().HasKey(a => a.TeamId);
            builder.Entity<Match>().HasKey(a => a.MatchId);
